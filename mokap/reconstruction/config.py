...
This defines all hyperparameters for the different stages of the pipeline

The configurations are separated by their role in the pipeline:
...
# ===================================================================
# Stage 1: 2D Detections -> 3D Point Soup
# ===================================================================
...
# ===================================================================
# Stage 2: 3D Point Soup -> Tracklets
# ===================================================================
...
class LinkerConfig:
    ...
    # `field(default_factory=...)` is used for mutable types like dicts.
